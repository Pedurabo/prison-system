...
<div class="container-fluid">
    <div class="row">
        <div class="col-12">
            <div class="d-flex justify-content-between align-items-center mb-4">
                ...
                <button class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#createGuardModal">
                    ...
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                Total Guards</div>
                            <div class="h5 mb-0 font-weight-bold text-gray-800">{{ $guards->count() }}</div>
                        </div>
                        <div class="col-auto">
                    ...
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            <div class="text-xs font-weight-bold text-success text-uppercase mb-1">
                                Active Guards</div>
                            <div class="h5 mb-0 font-weight-bold text-gray-800">{{ $guards->where('is_active', true)->count() }}</div>
                        </div>
                        <div class="col-auto">
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">Guard Management</h6>
        </div>
        <div class="card-body">
                ...
                <table class="table table-bordered" id="guardsTable" width="100%" cellspacing="0">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>{{ $guard->name }}</td>
                            <td>{{ $guard->email }}</td>
                            <td>{{ $guard->department->name ?? 'N/A' }}</td>
                            <td>
                            ...
                            <td>
                                <button class="btn btn-sm btn-info" onclick="editGuard({{ $guard->id }})">
