                    ...
                    <form action="{{ route('medical-records.store') }}" method="POST">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="attending_staff_id" id="attending_staff_id" class="form-control @error('attending_staff_id') is-invalid @enderror" required>
                                        ...
                                        @foreach($medicalStaff as $staff)
                                            <option value="{{ $staff->id }}" {{ old('attending_staff_id') == $staff->id ? 'selected' : '' }}>
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="symptoms" id="symptoms" rows="4"
                                      ...
                                      placeholder="Describe the symptoms..." required>{{ old('symptoms') }}</textarea>
                            @error('symptoms')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="treatment" id="treatment" rows="4"
                                      ...
                                      placeholder="Describe the treatment provided..." required>{{ old('treatment') }}</textarea>
                            @error('treatment')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
